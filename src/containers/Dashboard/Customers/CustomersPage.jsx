...
class CustomersPage extends Component {
  ...
  componentDidMount() {
    ...
    axios.get(apiRoutes.data).then((res) => {
      ...
      data.forEach((item) => {
        const {
          date, customer_work_area, customer_name, district,
        } = item;
        ...
        if (isDateValid) {
          if (dates[date]) {
            ...
            } else if (!dates[date][district][customer_name]) {
      ...
      this.setState({
        ...
        pieData: {
          ...
          datasets: [{
            ...
            backgroundColor: Object.keys(workAreas).map(() => getMaterialColor()),
          }],
        },
      });
        ...
        <Row className="p-0 m-0">
          <Col md={6} sm={12} className="p-0 m-0">
            <Card border="warning" className="m-2">
              <Card.Header>
                <BarChartFill />
                &nbsp;District Wise Customer Statistics /&nbsp;
                <b>{currentMonth}</b>
              </Card.Header>
              <Card.Body>
                <Bar
          ...
          <Col md={6} sm={12} className="p-0 m-0">
            <Card border="warning" className="m-2">
              <Card.Header>
                <PieChartFill />
                &nbsp;Work Area Wise Customer Comparison&nbsp;
              </Card.Header>
              <Card.Body>
                <Pie
                  data={pieData}
